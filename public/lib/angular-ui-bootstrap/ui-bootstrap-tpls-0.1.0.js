...
angular.module("ui.bootstrap.tpls", ["lib/angular-ui-bootstrap/template/accordion/accordion-group.html","lib/angular-ui-bootstrap/template/accordion/accordion.html","lib/angular-ui-bootstrap/template/alert/alert.html","lib/angular-ui-bootstrap/template/carousel/carousel.html","lib/angular-ui-bootstrap/template/carousel/slide.html","lib/angular-ui-bootstrap/template/dialog/message.html","lib/angular-ui-bootstrap/template/pagination/pagination.html","lib/angular-ui-bootstrap/template/popover/popover.html","lib/angular-ui-bootstrap/template/tabs/pane.html","lib/angular-ui-bootstrap/template/tabs/tabs.html","lib/angular-ui-bootstrap/template/tooltip/tooltip-popup.html"]);
...
angular.module('ui.bootstrap.accordion').directive('accordion', function () {
  return {
    ...
    transclude: true,
    replace: false,
    templateUrl: 'lib/angular-ui-bootstrap/template/accordion/accordion.html'
  };
});
...
angular.module('ui.bootstrap.accordion').directive('accordionGroup', ['$parse', '$transition', '$timeout', function($parse, $transition, $timeout) {
  return {
    ...
    templateUrl:'lib/angular-ui-bootstrap/template/accordion/accordion-group.html',
...
angular.module("ui.bootstrap.alert", []).directive('alert', function () {
  return {
    restrict:'EA',
    templateUrl:'lib/angular-ui-bootstrap/template/alert/alert.html',
    transclude:true,
    replace:true,
    scope:{
      type:'=',
...
.directive('carousel', [function() {
  return {
    ...
    require: 'carousel',
    templateUrl: 'lib/angular-ui-bootstrap/template/carousel/carousel.html',
    scope: {
      interval: '=',
      noTransition: '='
    }
...
.directive('slide', [function() {
  return {
    ...
    transclude: true,
    replace: true,
    templateUrl: 'lib/angular-ui-bootstrap/template/carousel/slide.html',
    scope: {
      active: '='
    },
  ...
  function ($http, $document, $compile, $rootScope, $controller, $templateCache, $q, $transition) {
    ...
    return {
      ...
      messageBox: function(title, message, buttons){
        return new Dialog({templateUrl: 'lib/angular-ui-bootstrap/template/dialog/message.html', controller: 'MessageBoxController', resolve: {model: {
          title: title,
          message: message,
          buttons: buttons
        }}});
...
.directive('pagination', function() {
  return {
    ...
    templateUrl: 'lib/angular-ui-bootstrap/template/pagination/pagination.html',
    replace: true,
    link: function(scope) {
...
.directive( 'popoverPopup', function () {
  return {
    ...
    templateUrl: 'lib/angular-ui-bootstrap/template/popover/popover.html'
  };
})
...
.directive('tabs', function() {
  return {
    ...
    templateUrl: 'lib/angular-ui-bootstrap/template/tabs/tabs.html',
    replace: true
  };
})
.directive('pane', ['$parse', function($parse) {
  return {
    ...
    templateUrl: 'lib/angular-ui-bootstrap/template/tabs/pane.html',
    replace: true
  };
}]);
...
.directive( 'tooltipPopup', function () {
  return {
    ...
    templateUrl: 'lib/angular-ui-bootstrap/template/tooltip/tooltip-popup.html'
  };
})
...
angular.module("lib/angular-ui-bootstrap/template/accordion/accordion-group.html", []).run(["$templateCache", function($templateCache){
  $templateCache.put("lib/angular-ui-bootstrap/template/accordion/accordion-group.html",
...
angular.module("lib/angular-ui-bootstrap/template/accordion/accordion.html", []).run(["$templateCache", function($templateCache){
  $templateCache.put("lib/angular-ui-bootstrap/template/accordion/accordion.html",
    "<div class=\"accordion\" ng-transclude></div>");
}]);

angular.module("lib/angular-ui-bootstrap/template/alert/alert.html", []).run(["$templateCache", function($templateCache){
  $templateCache.put("lib/angular-ui-bootstrap/template/alert/alert.html",
...
angular.module("lib/angular-ui-bootstrap/template/carousel/carousel.html", []).run(["$templateCache", function($templateCache){
  $templateCache.put("lib/angular-ui-bootstrap/template/carousel/carousel.html",
...
angular.module("lib/angular-ui-bootstrap/template/carousel/slide.html", []).run(["$templateCache", function($templateCache){
  $templateCache.put("lib/angular-ui-bootstrap/template/carousel/slide.html",
    "<div ng-class=\"{" +
...
angular.module("lib/angular-ui-bootstrap/template/dialog/message.html", []).run(["$templateCache", function($templateCache){
  $templateCache.put("lib/angular-ui-bootstrap/template/dialog/message.html",
...
angular.module("lib/angular-ui-bootstrap/template/pagination/pagination.html", []).run(["$templateCache", function($templateCache){
  $templateCache.put("lib/angular-ui-bootstrap/template/pagination/pagination.html",
...
angular.module("lib/angular-ui-bootstrap/template/popover/popover.html", []).run(["$templateCache", function($templateCache){
  $templateCache.put("lib/angular-ui-bootstrap/template/popover/popover.html",
...
angular.module("lib/angular-ui-bootstrap/template/tabs/pane.html", []).run(["$templateCache", function($templateCache){
  $templateCache.put("lib/angular-ui-bootstrap/template/tabs/pane.html",
    "<div class=\"tab-pane\" ng-class=\"{active: selected}\" ng-show=\"selected\" ng-transclude></div>" +
    "");
}]);

angular.module("lib/angular-ui-bootstrap/template/tabs/tabs.html", []).run(["$templateCache", function($templateCache){
  $templateCache.put("lib/angular-ui-bootstrap/template/tabs/tabs.html",
    "<div class=\"tabbable\">" +
...
angular.module("lib/angular-ui-bootstrap/template/tooltip/tooltip-popup.html", []).run(["$templateCache", function($templateCache){
  $templateCache.put("lib/angular-ui-bootstrap/template/tooltip/tooltip-popup.html",
